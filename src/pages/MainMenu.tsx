        ...
        <div className="flex flex-col lg:flex-row gap-5 w-full max-w-7xl">
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              ...
              className="bg-gradient-to-r from-green-400 to-blue-500 text-white px-6 py-4 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 flex items-center gap-3 min-w-[140px]"
            >
              <span className="text-2xl">💾</span>
              <div className="text-left">
                <div className="font-bold text-lg">本地存档</div>
                <div className="text-sm opacity-90">我的拼图</div>
              </div>
            </button>
          </div>
